...
Run the guided challenge with paste-output checks, hints, solution reveal, and private device progress at [labs.k8sllm.online/challenges/observability](https://labs.k8sllm.online/challenges/observability).
:::
