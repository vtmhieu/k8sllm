...
Start with [GPU Node Pool Kubernetes](/docs/llm-on-kubernetes/gpu-node-pools), run the [vLLM inference lab](/docs/labs/vllm-inference-lab), then move to [RAG On Kubernetes](/docs/llm-on-kubernetes/rag-on-kubernetes) and the [RAG retrieval lab](/docs/labs/rag-retrieval-lab).
