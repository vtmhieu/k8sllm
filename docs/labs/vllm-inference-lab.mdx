...
Run the guided challenge with paste-output checks, hints, solution reveal, and private device progress at [labs.k8sllm.online/challenges/vllm-inference](https://labs.k8sllm.online/challenges/vllm-inference).
:::
